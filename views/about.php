...
<?php $opinion = new Users_Opinion($conn);?>
                    ...
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src=<?php echo Base_Url . "public/images/users/" . $opinion_row['image'];?> alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3><?php echo $opinion_row['name'];?></h3>
                                <h5><?php echo $opinion_row['position'];?></h5>
